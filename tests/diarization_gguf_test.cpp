...
int main(int argc, char ** argv) {
    ...
    const std::string segmentation_default = cwd + "/models/gguf/pyannote-segmentation-3.0-pytorch-f32.gguf";
    const std::string embedding_default = cwd + "/models/gguf/pyannote-wespeaker-voxceleb-resnet34-LM-pytorch-f32.gguf";
